...
export class Carousel extends React.PureComponent {
  ...
  handlePrevClick = () => {
    //const upperBound = this.props.slides.length;
    //this.propTypes.slideIndexDecrement(upperBound);
  ...
  render() {
    // linter rule to ignore unused variables that start with underscore:
